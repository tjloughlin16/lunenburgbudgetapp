...
from taxbase import (TAX_RATE, LEVY, TOTAL_VALUE, RESIDENTIAL_SHARE, CIP_SHARE,
    ...
    FY23, BASE, BUSINESSES, EMPLOYEES, PAYROLL, AVG_COMMERCIAL_VALUE, BASE_NEW_VALUE,
    COMMERCIAL_CONTEXT, NEW_GROWTH_HISTORY, VALUE_BY_CLASS, VALUE_BY_CLASS_SERIES, AVG_HOME_HISTORY,
...
data = dict(
    ...
    taxBase=dict(
        ...
        levyGrowth=0.025,
        fy23=FY23, base=BASE, businesses=BUSINESSES, employees=EMPLOYEES, payroll=PAYROLL,
        avgCommercialValue=AVG_COMMERCIAL_VALUE, baseNewValue=BASE_NEW_VALUE,
        commercialContext=COMMERCIAL_CONTEXT,
        newGrowthHistory=NEW_GROWTH_HISTORY, valueByClass=VALUE_BY_CLASS, valueByClassSeries=VALUE_BY_CLASS_SERIES,
