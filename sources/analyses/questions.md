...
Returns `source_type`, `basis`, `documents` — for example: source_type=primary, basis=None, documents=1043
...
Returns `source_type`, `documents` — for example: source_type=primary, documents=1043
