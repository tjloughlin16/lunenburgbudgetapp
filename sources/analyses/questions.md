...
Returns `source_type`, `basis`, `documents` — for example: source_type=primary, basis=None, documents=367
...
Returns `source_type`, `documents` — for example: source_type=primary, documents=367
