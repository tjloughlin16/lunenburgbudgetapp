...
25,138 documents, 101 datasets, and 12,065 agendas and sets
...
| every dataset, with row counts and sizes | [`fy28/public/api/tables.json`](https://raw.githubusercontent.com/tjloughlin16/lunenburgbudgetapp/main/fy28/public/api/tables.json) — 92 of them |
...
**The documents themselves are not in this repository.** 25,138 files, 1.47 GB, live
...
| `sources/data/` | 101 datasets extracted from those documents, CSV |
