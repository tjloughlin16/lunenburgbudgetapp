...
29,048 documents, 147 datasets, and 12,129 agendas and sets
...
| every dataset, with row counts and sizes | [`fy28/public/api/tables.json`](https://raw.githubusercontent.com/tjloughlin16/lunenburgbudgetapp/main/fy28/public/api/tables.json) — 100 of them |
...
**The documents themselves are not in this repository.** 29,048 files, 1.47 GB, live
...
| `sources/data/` | 147 datasets extracted from those documents, CSV |
