...
28,002 documents, 132 datasets, and 12,089 agendas and sets
...
| every dataset, with row counts and sizes | [`fy28/public/api/tables.json`](https://raw.githubusercontent.com/tjloughlin16/lunenburgbudgetapp/main/fy28/public/api/tables.json) — 97 of them |
...
**The documents themselves are not in this repository.** 28,002 files, 1.47 GB, live
...
| `sources/data/` | 132 datasets extracted from those documents, CSV |
