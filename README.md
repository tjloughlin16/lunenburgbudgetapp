...
30,956 documents, 196 datasets, and 12,138 agendas and sets
...
**The documents themselves are not in this repository.** 30,956 files, 1.47 GB, live
...
| `sources/data/` | 196 datasets extracted from those documents, CSV |
