...
31,029 documents, 199 datasets, and 12,144 agendas and sets
...
**The documents themselves are not in this repository.** 31,029 files, 1.47 GB, live
...
| `sources/data/` | 199 datasets extracted from those documents, CSV |
