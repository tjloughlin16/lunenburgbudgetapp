...
26,462 documents, 126 datasets, and 12,088 agendas and sets
...
**The documents themselves are not in this repository.** 26,462 files, 1.47 GB, live
...
| `sources/data/` | 126 datasets extracted from those documents, CSV |
