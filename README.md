...
27,879 documents, 129 datasets, and 12,089 agendas and sets
...
**The documents themselves are not in this repository.** 27,879 files, 1.47 GB, live
...
| `sources/data/` | 129 datasets extracted from those documents, CSV |
