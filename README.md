...
31,017 documents, 197 datasets, and 12,144 agendas and sets
...
**The documents themselves are not in this repository.** 31,017 files, 1.47 GB, live
...
| `sources/data/` | 197 datasets extracted from those documents, CSV |
