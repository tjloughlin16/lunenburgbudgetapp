...
108 questions this archive can answer, in plain English. Every one has been run against the data, so nothing on this list is a question we merely hope is answerable.
