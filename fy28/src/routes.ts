...
const ALIASES: Record<string, Tab> = {
  ...
  'budget-feed': 'budgetfeed', 'budget-season': 'budgetfeed', 'budget-calendar': 'budgetfeed', 'budget-news': 'budgetfeed',
...
export const LABEL: Record<Tab, string> = {
  ...
  budgetfeed: 'The budget feed — every board, everything about money',
  ...
  salarylever: 'Teacher contracts',
  feelever: 'School user and athletic fees',
  extraslever: 'Extracurriculars — sports, music and clubs',
  positionslever: 'Classroom positions and class size',
