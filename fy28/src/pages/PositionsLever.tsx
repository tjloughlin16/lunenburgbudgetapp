  ...
  return (
    <ReportShell tab={TAB} dataUrl="/data/model.json"
      ...
      <FullVersion what="the arithmetic, and what was already cut">
        ...
        <DoesNot>
          It does not change the rate either. Fewer positions is a smaller base growing at the same {pct(DEFAULT_RATES.salaries, 0)}; the gap reopens the next year on the smaller base. Only <a className="underline" href="/salaries">the settlement</a> and <a className="underline" href="/health-insurance-what-changing-the-plan-does">the health plan</a> move the rate, and an <a className="underline" href="/override">override</a> moves the other side of it.
        </DoesNot>
