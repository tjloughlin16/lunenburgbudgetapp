  ...
  return (
    <ReportShell tab={TAB} dataUrl="/data/model.json"
      ...
      <FullVersion what="the arithmetic, and the question as put">
        ...
        <DoesNot>
          It does not change the rate. Costs grow {pct(GAPS[1].growthRate, 1)} a year and the levy {pct(0.025, 1)}; a one-time appropriation, however large, leaves both where they were, and the same gap is back the next spring plus growth. The two things that change the rate are on <a className="underline" href="/health-insurance">health insurance</a> and <a className="underline" href="/salaries">the teacher contracts</a>.
        </DoesNot>
