      ...
      <section data-section="conclusions" data-short="">
        ...
        <div className="grid gap-4 mt-4 md:grid-cols-2">
          <Insight n={4} figure={n0(HOMES_TO_HOLD)} tone="var(--series-revenue)"
            headline={<>A new home that brings no pupil pays about {usd(HOME_PAYS)} a year toward the schools; the gap needs about {n0(HOMES_TO_HOLD)} such homes a year and the town adds about {n0(Math.round(d.window5.homes / (d.window5.last_fy - d.window5.first_fy)))}.</>}>
