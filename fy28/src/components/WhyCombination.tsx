    ...
    <div>
      ...
      <div className="grid gap-3 lg:grid-cols-2 items-start">
        ...
        <div className="card p-4 sm:p-5">
          ...
          <p className="text-[13px] leading-relaxed mt-2"
            style={{ color: 'var(--text-secondary)' }}>
            <span data-point="">There is no arrangement of the other five lines that reaches the bar while
            salaries go on rising 4%.</span> It can be paid around &mdash; with{' '}
