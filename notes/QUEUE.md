...
| A10 | **The district publishes no top layer after FY2022** | `/org-charts` shows Lunenburg Public Schools with 250 people in four buildings and NOBODY above them: School Central Office appears in 8 of 15 years and stops after FY2022, and the Superintendent is named only in FY2011 and FY2012. Found by building the org chart, which is what it is for — a count would never have shown it. Either the district stopped printing that roster or we have not found it. | open |
