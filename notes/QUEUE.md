...
| A0c | **FACILITIES IS A TOWN DEPARTMENT AND IS IN NONE OF THIS.** TJ, 22 September: *"which dept does Chris Ruth show up in?!"* — he does not. | **He is the Facilities Director, and the town says so in three places we already hold.** The Town Office Hours page lists `FACILITES DIRECTOR (Chris Ruth)` beside LIBRARY and ELECTRICAL INSPECTOR with its own hours and phone — that page is the town listing its own departments. The FY2023 report names him in a line of department heads: *"Sue Doherty, COA Director; Muir Haman, Library Director; Kathy Herrick, Town Clerk; Chris Ruth, Facilities Director"*. The FY2023 ledger carries `FACILITIES & BUILDINGS / Facilities & Grounds` with its own payroll. And TJ said earlier in the same session that *"Facilities used to be a part of DPW. It was split off."* The org chart has no Facilities unit because Facilities files no annual report and the officials listing does not appoint it — our two sources for departments both miss it. | **Do not hardcode it.** The fix is to read the TOWN OFFICE HOURS page, which is printed in every annual report and is the town’s own list of the departments a resident can walk into — a third source for what departments exist, independent of the contents page and the officials listing, and it would likely find more than Facilities. Then Chris Ruth is its Director and the FY27 presentations (A0b) fill in the rest. | open |
