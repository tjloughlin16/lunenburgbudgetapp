...
## 4a. Reading a season page as a resident

`notes/process/BUDGET-FEED-GUIDELINES.md` -- the checklist a season page is read against
before it ships, learned from three passes over FY27. For the budget feed only.
