...
## 4a. Reading a season page as a resident — what three passes over FY27 taught, for the budget feed only

TJ, after the passes: *"don't generalise too much. This is JUST for the budget feeds."* So
these live here, with the model, and nowhere else. They apply to every season file --
