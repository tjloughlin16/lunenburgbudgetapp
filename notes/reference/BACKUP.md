...
| `sources/data/` | tree; **1 of 197 nowhere else** | 54 MB | 197 | The datasets themselves, plus provenance and the extraction plan. CSV only — the directory total below includes the two above. | seconds, given everything above |
