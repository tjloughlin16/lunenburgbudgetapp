...
| `sources/data/` | tree; **4 of 196 nowhere else** | 54 MB | 196 | The datasets themselves, plus provenance and the extraction plan. CSV only — the directory total below includes the two above. | seconds, given everything above |
