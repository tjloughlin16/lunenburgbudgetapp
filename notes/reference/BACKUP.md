...
| `sources/data/` | tree; **2 of 186 nowhere else** | 53 MB | 186 | The datasets themselves, plus provenance and the extraction plan. CSV only — the directory total below includes the two above. | seconds, given everything above |
