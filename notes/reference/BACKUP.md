...
| `sources/data/` | tree + git + bucket | 37 MB | 128 | The datasets themselves, plus provenance and the extraction plan. CSV only — the directory total below includes the two above. | seconds, given everything above |
