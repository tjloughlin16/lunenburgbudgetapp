...
**4 decisions** and **13 open questions**. The gap registry behind the questions holds **114 rows** across 7 kinds: `curriculum`, `document_wanted`, `held`, `money_in`, `money_out`, `people`, `record`.
