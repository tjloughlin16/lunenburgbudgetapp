...
The Lunenburg Budget Project — for review, 20 September 2026

**4 decisions** and **13 open questions**. The gap registry behind the questions holds **151 rows** across 9 kinds: `curriculum`, `document_wanted`, `extraction`, `held`, `money_in`, `money_out`, `people`, `record`, `students`.
