...
The Lunenburg Budget Project — for review, 17 September 2026

**4 decisions** and **13 open questions**. The gap registry behind the questions holds **133 rows** across 8 kinds: `curriculum`, `document_wanted`, `held`, `money_in`, `money_out`, `people`, `record`, `students`.
