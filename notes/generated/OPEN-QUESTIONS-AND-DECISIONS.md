...
**4 decisions** and **13 open questions**. The gap registry behind the questions holds **72 rows** across 6 kinds: `document_wanted`, `held`, `money_in`, `money_out`, `people`, `record`.
