...
- **13,092 documents** — PDFs, spreadsheets, Word files and slide decks — 28,002 files and 5.39 GB in all, each with its address, its publisher’s filename and a checksum.
...
- **142 meetings with our own minutes** written from those recordings — **631 substantive votes** and **196 transfers** logged, each linked to the second of the video.
- **A database of 133,570 rows in 103 tables**, rebuilt from the documents on every run and queryable by anyone at `/api/query`.
- **17 analyses** and **139 published conclusions**, every figure recomputed by a script before it ships.
...
- **133 registered gaps** — questions the published record cannot answer, each with the one document that would close it.
