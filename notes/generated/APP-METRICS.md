...
*As of 2026-09-26. Every figure below is computed from the archive itself by `scripts/build_app_metrics.py`; none is typed.*

## What the town and the state published — and we hold

- **13,152 documents** — PDFs, spreadsheets, Word files and slide decks — 31,020 files and 5.79 GB in all, each with its address, its publisher’s filename and a checksum.
...
- **4,485 hours of meeting recordings transcribed** — 2,667 meetings, 186.9 days of audio end to end, 2012-05-02 to 2026-09-24. Machine captions, ours, a finding aid: they locate a moment; they do not settle what was said.
...
- **173 registered gaps** — questions the published record cannot answer, each with the one document that would close it.
