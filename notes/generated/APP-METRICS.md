...
*As of 2026-09-21. Every figure below is computed from the archive itself by `scripts/build_app_metrics.py`; none is typed.*

## What the town and the state published — and we hold

- **13,111 documents** — PDFs, spreadsheets, Word files and slide decks — 29,852 files and 5.64 GB in all, each with its address, its publisher’s filename and a checksum.
...
- **12,132 meeting documents** from **51 town boards**: 4,701 sets of minutes and 7,431 agendas, 2009-01-05 to 2026-09-21 — **18 years**.
...
- **21 analyses** and **152 published conclusions**, every figure recomputed by a script before it ships.
...
- **153 registered gaps** — questions the published record cannot answer, each with the one document that would close it.
