...
CHECKS = [
    ...
    ('build_open_seats.py', ['--check']),
    ('build_board_composition.py', ['--check']),
    ('build_board_composition_charts.py', ['--check']),
    ('build_town_data_provenance.py', ['--check']),
    ('build_town_budgets.py', ['--check']),
    ('build_town_budgets_charts.py', ['--check']),
    ('extract_report_index.py', ['--check']),
    ('extract_staffing_by_section.py', ['--check']),
    ('build_staffing_coverage.py', ['--check']),
    ...
    # Every page and the points its short version carries, read off the same build.
    ('build_short_versions.py', ['--check']),
    ...
    ('extract_document_timestamps.py', ['--check']),
    ('build_health_options.py', ['--check']),
    ...
    ('write_document_budget_state.py', ['--check']),
    ('fetch_board_pages.py', ['--check']),
    ('fetch_dls_tax_bills.py', ['--check']),
    ('fetch_dls_property.py', ['--check']),
    ('build_commercial_base.py', ['--check']),
