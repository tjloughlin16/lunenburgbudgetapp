...
def main():
    ...
    lines = [
        ...
        # OPEN SEATS IS THE ONE ENDPOINT HERE SOMEBODY ACTS ON. Everything else on this
        # table is for understanding the town; this one says which of its boards has a
        # chair free, and it is the answer to a question an assistant is actually asked.
        # Regenerated by the daily refresh, so it is as current as the listing behind it.
        f'| which town boards have a seat open, and when terms end | '
        f'`{SITE}/data/open-seats.json` |',
